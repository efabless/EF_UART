...
class ip_interrupt(UVMSequenceItem):
    ...
    def convert2string(self):
        return sv.sformatf("rx_timeout = %d, rx_break_line = %d, rx_wrong_parity = %d, rx_frame_error = %d", self.rx_timeout, self.rx_break_line, self.rx_wrong_parity, self.rx_frame_error)


uvm_object_utils(ip_interrupt)
